...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 10000, 5200);
    $InitializeEvent(1, 10000, 5201);
    $InitializeEvent(2, 10000, 5202);
    $InitializeEvent(3, 10000, 5203);
    $InitializeEvent(4, 10000, 5204);
    $InitializeEvent(5, 10000, 5205);
    $InitializeEvent(6, 10000, 5206);
    $InitializeEvent(7, 10000, 5207);
    $InitializeEvent(8, 10000, 5208);
    $InitializeEvent(9, 10000, 5209);
    $InitializeEvent(10, 10000, 5210);
    $InitializeEvent(11, 10000, 5211);
    $InitializeEvent(12, 10000, 5212);
    $InitializeEvent(13, 10000, 5213);
    $InitializeEvent(14, 10000, 5220);
    $InitializeEvent(15, 10000, 5221);
    $InitializeEvent(16, 10000, 5222);
    if (EventFlag(2300)) {
...
$Event(10000, Default, function(item_id) {
    EndIf(PlayerHasItem(ItemType.Goods, item_id));
    WaitFor(PlayerHasItem(ItemType.Goods, item_id));
    AwardItemLot(51000);
});
